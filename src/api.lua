...
apiList = {
	...
	[ "csize" ] = { api.csize, 1 },
	[ "rect" ] = { api.rect, 1 },
	[ "rectfill" ] = { api.rectfill, 1 },
	[ "brect" ] = { api.brect, 1 },
	[ "brectfill" ] = { api.brectfill, 1 },
	[ "color" ] = { api.color, 1 },
	[ "cls" ] = { api.cls, 1 },
	[ "circ" ] = { api.circ, 1 },
	[ "circfill" ] = { api.circfill, 1 },
	[ "pset" ] = { api.pset, 1 },
	[ "pget" ] = { api.pget, 1 },
	[ "line" ] = { api.line, 1 },
	[ "print" ] = { api.print, 1 },
	...
	[ "tri" ] = { api.tri, 1 },
	[ "trifill" ] = { api.trifill, 1 },
	[ "poly" ] = { api.poly, 1 },
	[ "polyfill" ] = { api.polyfill, 1 },
	...
	[ "minify" ] = { commands.minify, 1 },
	[ "pwd" ] = { commands.pwd, 1 },
	[ "ls" ] = { commands.ls, 1 },
	[ "install_demos" ] = { commands.installDemos, 1 },
	[ "exit" ] = { api.exit, 1 },
	[ "unload" ] = { api.unload, 1 },
